...
namespace Oxide.Plugins
{
    ...
    public class Duelist : RustPlugin
    {
        ...
        private object OnEntityTakeDamage(BaseCombatEntity entity, HitInfo hitInfo)
        {
            ...
            if (victim?.transform != null && hitInfo.Initiator != null && hitInfo.Initiator.ShortPrefabName.Contains("wall.external.high") && vdt) // 1.0.2 - exploit fix
                return false;
            ...
            if (hitInfo.Initiator != null && !hitInfo.Initiator.IsDestroyed && hitInfo.Initiator.IsNpc && (adt || vdt)) // 1.2.0
            {
                ...
                else if (hitInfo.Initiator is BasePlayer)
                {
                    ...
                    if (npc != null)
                    {
                        var scientist = npc as Scientist;
                        if (scientist != null) scientist.LootSpawnSlots = new LootContainer.LootSpawnSlot[0];

                        var murderer = npc as NPCMurderer;
                        if (murderer != null) murderer.LootSpawnSlots = new LootContainer.LootSpawnSlot[0];
        ...
        private void OnEntitySpawned(BaseNetworkable entity)
        {
            ...
            if (prefabs.ContainsKey(entity.PrefabName) && e.name.Contains("barricade."))
            {
        ...
        {
            return init && duelingZones.Any(zone => Vector3.Distance(new Vector3(zone.Position.x, position.y, zone.Position.z), position) <= zoneRadius + offset);
        }
        ...
        public string msg(string key, string id = null, params object[] args)
        {
            ...
            if (message.Contains("=lime"))
                message = message.Replace("=lime", "=#00FF00");
